...
// // in this method the original araay will nnot be change


// // splice : 
// num.splice(3, 2 ,200 , 300 , 400 , 500 , 600 , 700 , 800) // here 3 is denote as the from the 3rd index we will delete and replace(new values) the values from the main array amd second value which is 2 is denote the how many item will be removed.
// console.log(num);
